...
testthat("nude test", {
  test.message <- "{\"content\":{\"action\":\"create\",\"documents\":[{\"type\":\"account_form\",\"post_date\":\"2001-01-01T00:00:00+3\",\"create_summary\":false,\"header\":{\"period\":2001},\"fields\":{\"someVariableOnMessage\":100.1}}]}}"

  url = "http://localhost:8000/antares/msg/api/message/"


  RCurl::postForm(url,
             .opts = list(postfields = test.message, httpheader = c('Content-Type' = 'application/json',
